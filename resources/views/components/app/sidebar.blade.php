            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition" href="/dashboard">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 fill-current" xmlns="http://www.w3.org/2000/svg" width="16"
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-8 mt-1 @if (!in_array(Request::segment(1), ['dashboard'])) {{ 'hidden' }} @endif"
                                :class="open ? 'block!' : 'hidden'"></ul>
                        </div>
                    </li>
                    <!-- E-Commerce -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition" href="/admin/data-users">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 fill-current" xmlns="http://www.w3.org/2000/svg" width="16"
                                        height="16" viewBox="0 0 16 16">
                    ...
                    <!-- Community -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition" href="/admin/data-buku">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 fill-current" xmlns="http://www.w3.org/2000/svg" width="16"
                                        height="16" viewBox="0 0 16 16">
